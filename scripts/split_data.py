...
class Args(Tap):
    ...
    smiles_columns: List[
        str
    ] = None  # Name of the column containing SMILES strings. By default, uses the first column.
...
def run_split_data(args: Args):
    ...
    train, val, test = split_data(
        data=data, split_type=args.split_type, sizes=args.split_sizes, seed=args.seed
    )
